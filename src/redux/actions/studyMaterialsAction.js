...
//USING AXIOS
export function getStudyMaterialsData(param){
  const request = axios.post(Constant.BASEURL+Constant.UPDATE_STATUS,param,Utils.postHeader());
  return dispatch => {
